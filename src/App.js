    ...
    <div className={styles.App}>
      ...
      <Container className={styles.Main}>
        <Switch>
          ...
          <Route
            exact
            path="/upcoming-blogs/create"
            render={() => <UpcomingBlogsCreateForm />}
          />
          <Route
            exact
            path="/upcoming-blogs"
            render={() => <UpcomingBlogs />}
          />
          <Route
            exact
            path="/upcoming-blogs/:id/edit"
            render={() => <UpcomingBlogsEditForm />}
          />
          <Route exact path="/tickets" render={() => <ContactPage />} />
          <Route
            exact
            path="/tickets/:id/edit"
            render={() => <ContactTicketEditPage />}
          />
          <Route
            exact
            path="/blogs/:cat/:id/edit"
            render={() => <BlogEditForm />}
          />
          <Route
            exact
